// ==UserScript==
// @name meishuu's Upgrade Manager
// @namespace https://github.com/pBun/steamSummerMinigameUpgrades
// @description A script that auto-upgrades the Steam Monster Minigame for you.
// @version 1.0.0
// @match *://steamcommunity.com/minigame/towerattack*
// @match *://steamcommunity.com//minigame/towerattack*
// @grant none
// @updateURL https://raw.githubusercontent.com/pBun/steamSummerMinigameUpgrades/master/upgradeManager.js
// @downloadURL https://raw.githubusercontent.com/pBun/steamSummerMinigameUpgrades/master/upgradeManager.js
// ==/UserScript==

// IMPORTANT: Update the @version property above to a higher number such as 1.1 and 1.2 when you update the script! Otherwise, Tamper / Greasemonkey users will not update automatically.

if (initAutoUpgrade) window.clearTimeout(initAutoUpgrade);
var initAutoUpgrade = window.setInterval(function() {
    if (!g_Minigame
    || typeof g_Minigame.CurrentScene !== 'function'
    || !g_Minigame.CurrentScene().m_bRunning
    || !g_Minigame.CurrentScene().m_rgPlayerTechTree
    || !g_Minigame.CurrentScene().m_rgGameData
    || !g_Minigame.CurrentScene().m_rgTuningData) {
       return;
    }
    window.clearTimeout(initAutoUpgrade)
